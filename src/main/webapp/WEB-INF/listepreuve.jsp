...
<div style="    padding: 1.5rem;    margin-right: 0;    margin-left: 0;    border-width: .2rem;">
    ...
    <form class="form-inline my-2 my-lg-10" action="listepreuve" method="post">
      <a href="/ApplicationJoueur/listepreuve"  role="button" data-bs-toggle="button" style="position:relative; left:330px; top:-40px"><img class="mb-4" src="refresh.png" alt="" style=""></a>
    </form>
