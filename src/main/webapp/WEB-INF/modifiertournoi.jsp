...
<form class="needs-validation "  novalidate method="post" action="modifiertournoi">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" style="width:400px;" id="validationCustom01" name="txtTournoi" value='${tournoi.nom}' required>
  ...
  <button class="btn btn-primary center" type="submit">Modifier le tournoi</button>
</form>
