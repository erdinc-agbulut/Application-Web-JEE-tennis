...
<html lang="fr">
  <head>
    ...
    <title>Liste des vainqueurs</title>
...
<div style="    padding: 1.5rem;    margin-right: 0;    margin-left: 0;    border-width: .2rem;">
	 ...
	 <form class="form-inline my-2 my-lg-0" action="listvainqueur" method="post">
      <input class="form-control mr-sm-2" type="text" name="txtsearch" placeholder="Search" aria-label="Search">
      <button class="btn btn-secondary my-2 my-sm-0" type="submit" name="action1" value="Rechercher">Rechercher un vainqueur</button>
    </form>
    
    <form class="form-inline my-2 my-lg-10" action="listvainqueur" method="post">
      <a href="/ApplicationJoueur/listvainqueur"  role="button" data-bs-toggle="button" style="position:relative; left:430px; top:-40px"><img class="mb-4" src="refresh.png" alt="" style=""></a>
    </form>
