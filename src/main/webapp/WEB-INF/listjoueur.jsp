...
<a class="btn btn-primary" href="/ApplicationJoueur/ajouterjoueur" role="button">Ajouter un joueur</a>
<a href="/ApplicationJoueur/listjoueur"  role="button" data-bs-toggle="button" style="position:relative; left:5px; top:10px"><img class="mb-4" src="refresh.png" alt="" style=""></a>
...
<table class="table">
  ...
  <tr>
  	...
  	<td>
	    ...
	    <a type="submit" class="btn btn-outline-primary" href="/ApplicationJoueur/modifierjoueur?id=${ joueur.id }" role="button"  >Modifier</a>
		<a type="submit" class="btn btn-outline-warning" href="/ApplicationJoueur/supprimerjoueur?id=${ joueur.id }" role="button"  >Supprimer</a>
