...
@WebServlet("/listvainqueur")
public class ListVainqueur extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private JoueurDao joueurDao;
	
    public ListVainqueur() {
        super();
     }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("joueurs", joueurDao.listerVainqueurs());
		this.getServletContext().getRequestDispatcher("/WEB-INF/listvainqueur.jsp").forward(request, response);
